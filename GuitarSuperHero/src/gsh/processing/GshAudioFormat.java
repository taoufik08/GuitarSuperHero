...
public class GshAudioFormat {
     ...
     *                                                  means little-endian)
     */
    public GshAudioFormat(Encoding encoding, float sampleRate, int sampleSizeInBits,
     ...
     * @since 1.5
     */
    public GshAudioFormat(Encoding encoding, float sampleRate,
     ...
     *                                                  means little-endian)
     */
    public GshAudioFormat(float sampleRate, int sampleSizeInBits,
     ...
     */
    public boolean matches(GshAudioFormat format) {
