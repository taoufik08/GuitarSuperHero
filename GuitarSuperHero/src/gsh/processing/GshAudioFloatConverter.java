...
import gsh.processing.GshAudioFormat.Encoding;


public abstract class GshAudioFloatConverter {
	
	public static final Encoding PCM_FLOAT = new Encoding("PCM_FLOAT");

    
    private static class AudioFloatLSBFilter extends GshAudioFloatConverter {

        private GshAudioFloatConverter converter;
        ...
        public AudioFloatLSBFilter(GshAudioFloatConverter converter,
        		GshAudioFormat format) {
    ...
    private static class AudioFloatConversion64L extends GshAudioFloatConverter {
    ...
    private static class AudioFloatConversion64B extends GshAudioFloatConverter {
        ByteBuffer bytebuffer = null;
    ...
    private static class AudioFloatConversion32L extends GshAudioFloatConverter {
        ByteBuffer bytebuffer = null;
    ...
    private static class AudioFloatConversion32B extends GshAudioFloatConverter {
        ByteBuffer bytebuffer = null;
    ...
    // PCM 8 bit, signed
    private static class AudioFloatConversion8S extends GshAudioFloatConverter {
        public float[] toFloatArray(byte[] in_buff, int in_offset,
                float[] out_buff, int out_offset, int out_len) {
            int ix = in_offset;
            int ox = out_offset;
    ...
    // PCM 8 bit, unsigned
    private static class AudioFloatConversion8U extends GshAudioFloatConverter {
        public float[] toFloatArray(byte[] in_buff, int in_offset,
                float[] out_buff, int out_offset, int out_len) {
            int ix = in_offset;
            int ox = out_offset;
    ...
    private static class AudioFloatConversion16SL extends GshAudioFloatConverter {
        public float[] toFloatArray(byte[] in_buff, int in_offset,
                float[] out_buff, int out_offset, int out_len) {
            int ix = in_offset;
    ...
    private static class AudioFloatConversion16SB extends GshAudioFloatConverter {
        public float[] toFloatArray(byte[] in_buff, int in_offset,
                float[] out_buff, int out_offset, int out_len) {
            int ix = in_offset;
            int ox = out_offset;
    ...
    private static class AudioFloatConversion16UL extends GshAudioFloatConverter {
        public float[] toFloatArray(byte[] in_buff, int in_offset,
                float[] out_buff, int out_offset, int out_len) {
            int ix = in_offset;
            int ox = out_offset;
    ...
    private static class AudioFloatConversion16UB extends GshAudioFloatConverter {
        public float[] toFloatArray(byte[] in_buff, int in_offset,
                float[] out_buff, int out_offset, int out_len) {
            int ix = in_offset;
            int ox = out_offset;
    ...
    private static class AudioFloatConversion24SL extends GshAudioFloatConverter {
        public float[] toFloatArray(byte[] in_buff, int in_offset,
                float[] out_buff, int out_offset, int out_len) {
            int ix = in_offset;
            int ox = out_offset;
    ...
    private static class AudioFloatConversion24SB extends GshAudioFloatConverter {
        public float[] toFloatArray(byte[] in_buff, int in_offset,
                float[] out_buff, int out_offset, int out_len) {
            int ix = in_offset;
            int ox = out_offset;
    ...
    private static class AudioFloatConversion24UL extends GshAudioFloatConverter {
        public float[] toFloatArray(byte[] in_buff, int in_offset,
                float[] out_buff, int out_offset, int out_len) {
            int ix = in_offset;
            int ox = out_offset;
    ...
    private static class AudioFloatConversion24UB extends GshAudioFloatConverter {
        public float[] toFloatArray(byte[] in_buff, int in_offset,
                float[] out_buff, int out_offset, int out_len) {
            int ix = in_offset;
            int ox = out_offset;
    ...
    private static class AudioFloatConversion32SL extends GshAudioFloatConverter {
        public float[] toFloatArray(byte[] in_buff, int in_offset,
                float[] out_buff, int out_offset, int out_len) {
            int ix = in_offset;
            int ox = out_offset;
    ...
    private static class AudioFloatConversion32SB extends GshAudioFloatConverter {
        public float[] toFloatArray(byte[] in_buff, int in_offset,
                float[] out_buff, int out_offset, int out_len) {
            int ix = in_offset;
            int ox = out_offset;
    ...
    private static class AudioFloatConversion32UL extends GshAudioFloatConverter {
        public float[] toFloatArray(byte[] in_buff, int in_offset,
                float[] out_buff, int out_offset, int out_len) {
            int ix = in_offset;
            int ox = out_offset;
    ...
    private static class AudioFloatConversion32UB extends GshAudioFloatConverter {
    ...
    // PCM 32+ bit, signed, little-endian
    private static class AudioFloatConversion32xSL extends GshAudioFloatConverter {
    ...
    // PCM 32+ bit, signed, big-endian
    private static class AudioFloatConversion32xSB extends GshAudioFloatConverter {
    ...
    // PCM 32+ bit, unsigned, little-endian
    private static class AudioFloatConversion32xUL extends GshAudioFloatConverter {
    ...
    // PCM 32+ bit, unsigned, big-endian
    private static class AudioFloatConversion32xUB extends GshAudioFloatConverter {
    ...
    public static GshAudioFloatConverter getConverter(GshAudioFormat format) {
    	GshAudioFloatConverter conv = null;
