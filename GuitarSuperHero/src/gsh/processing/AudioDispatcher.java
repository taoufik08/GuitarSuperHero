...
import gsh.processing.GshAudioFloatConverter;
...
public class AudioDispatcher implements Runnable {
	 ...
	 * moment.
	 */
	private final GshAudioInputStream audioInputStream;
	 ...
	 * versa).
	 */
	private final GshAudioFloatConverter converter;
	
	private final GshAudioFormat format;
	 ...
	 */
	public AudioDispatcher(final GshAudioInputStream stream, final int audioBufferSize, final int bufferOverlap){
		...
		converter = GshAudioFloatConverter.getConverter(format);
